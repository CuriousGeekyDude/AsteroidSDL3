...
namespace Asteroid
{
	...
	class EventManager final
	{
		...
		typedef std::unordered_map<EventType, std::vector<std::function<void(IEvent*)>>> EventTypesMappedToDelegates;
		typedef std::array<std::vector<IEvent*>, m_totalNumQueues> EventQueues;
	...
	public:
		...
		void AssociateNewDelegateToEventType(const EventType l_eventType, std::function<void(IEvent*)>&& l_delegate);
